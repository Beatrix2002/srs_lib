...
local function triggerServerCallback(_, event, delay, cb, ...)
    ...
    TriggerServerEvent('srs_lib:validateCallback', event, srs.cache.resource, key)
    TriggerServerEvent(cbEvent:format(event), srs.cache.resource, key, ...)
...
function srs.callback.await(event, delay, ...)
